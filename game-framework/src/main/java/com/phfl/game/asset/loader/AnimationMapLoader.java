...
public class AnimationMapLoader
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AnimationMapLoader.class);
    ...
    public AnimationMap load(AssetManager assetManager, String fileName, FileHandle file,
        ...
        for (String animationName : animations.keySet()) {
            ...
            // animationName,
            // yaml.dump(animations.get(animationName)));
    ...
    private Array<TextureRegion> createKeyFrames(Texture texture,
            int w, int h,
            int ox, int oy,
            int frames) {
